...
Saurron is a free and open source software application which monitors containers on a single host, detects newer images, and automatically updates them - with safe rollback, structured audit logging, and flexible notifications.
